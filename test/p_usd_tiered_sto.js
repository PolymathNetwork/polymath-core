...
contract("USDTieredSTO", accounts => {
    ...
    describe("Test modifying configuration", async () => {
        ...
        it("Should fail to change config after endTime", async () => {
            ...
            await catchRevert(
                I_USDTieredSTO_Array[stoId].modifyLimits(BigNumber(15 * 10 ** 18), BigNumber(1 * 10 ** 18), { from: ISSUER })
            );
    ...
    describe("Test cases for the USDTieredSTOFactory", async () => {
        it("should get the exact details of the factory", async () => {
            ...
            "It allows both accredited and non-accredited investors to contribute into the STO. Non-accredited investors will be capped at a maximum investment limit (as a default or specific to their jurisdiction). Tokens will sold according to tiers sequentially & each tier has its own price and volume of tokens to sell. Upon receipt of funds (ETH, POLY or DAI), security tokens will automatically transfer to investor’s wallet address",
            "Wrong Module added");
            ...
            assert.equal(await I_USDTieredSTOFactory.version.call(), "1.0.0");
