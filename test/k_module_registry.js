    ...
    describe("Test cases for the ModuleRegistry", async () => {
        ...
        describe("Test cases for the useModule function of the module registry", async () => {
            it("Deploy the securityToken", async () => {
                ...
                let tx = await I_STRProxied.generateSecurityToken(name, symbol, tokenDetails, true, "0x0000000000000000000000000000000000000000", { from: account_issuer });
            ...
            it("Should failed in adding the TestSTOFactory module because not compatible with the current protocol version --upper", async () => {
                ...
                let tx = await I_STRProxied.generateSecurityToken(name, newSymbol, tokenDetails, true, "0x0000000000000000000000000000000000000000", { from: account_issuer });
