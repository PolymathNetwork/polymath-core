    ...
    describe("Buy tokens using on-chain whitelist", async() => {
        ...
        it("Fuzz test balance checkpoints", async() => {
            ...
            for (let j = 0; j < 10; j++) {
                ...
                console.log("Checkpoint: " + (j + 1) + " Balances: " + JSON.stringify(cps[cps.length - 1]));
            ...
            // for (let kk = 0; kk < cps.length; kk++) {
            //     console.log("CP Balance:   " + BigNumber(await I_SecurityToken.balanceOfAt(account_investor1, kk + 1)).toString());
            //     console.log("Rec. Balance: " + cps[kk][0]);
            //     for (let ll = 0; ll < 10; ll++) {
            //         try {
            //           console.log(JSON.stringify(await I_SecurityToken.checkpointBalances(account_investor1, ll)));
            //         } catch (error) {}
            //     }
            // }
