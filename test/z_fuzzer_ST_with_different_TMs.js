...
contract('GeneralPermissionManager', accounts => {
    ...
    describe("Generate the SecurityToken", async () => {
        ...
        it("Should mint the tokens", async () => {
            ...
            tx = await I_GeneralTransferManager.modifyWhitelist(account_investor2, fromTime, toTime, expiryTime, true, {
                from: token_owner,
                gas: 6000000
            });

            console.log("2");
            await I_SecurityToken.mint(account_investor1, 100 * Math.pow(10, 18), { from: token_owner, gas: 500000 });
