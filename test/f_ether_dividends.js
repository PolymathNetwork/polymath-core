...
contract("EtherDividendCheckpoint", accounts => {
    ...
    describe("Check Dividend payouts", async () => {
        ...
        it("Set withholding tax of 20% on investor 2", async () => {
            await I_EtherDividendCheckpoint.setWithholdingFixed([account_investor2], web3.utils.toBN(20 * 10 ** 16), { from: token_owner });
        });
        ...
        it("Issuer pushes dividends iterating over account holders - dividends proportional to checkpoint", async () => {
            let investor1Balance = new web3.utils.toBN(await web3.eth.getBalance(account_investor1));
            let investor2Balance = new web3.utils.toBN(await web3.eth.getBalance(account_investor2));
            await I_EtherDividendCheckpoint.pushDividendPayment(0, 0, 10, { from: token_owner });
            let investor1BalanceAfter = new web3.utils.toBN(await web3.eth.getBalance(account_investor1));
            let investor2BalanceAfter = new web3.utils.toBN(await web3.eth.getBalance(account_investor2));
        ...
        it("Issuer reclaims withholding tax", async () => {
            let issuerBalance = new web3.utils.toBN(await web3.eth.getBalance(token_owner));
            await I_EtherDividendCheckpoint.withdrawWithholding(0, { from: token_owner, gasPrice: 0 });
            let issuerBalanceAfter = new web3.utils.toBN(await web3.eth.getBalance(token_owner));
        ...
        it("should investor 3 claims dividend - fails bad index", async () => {
            let investor1Balance = new web3.utils.toBN(await I_PolyToken.balanceOf(account_investor1));
            let investor2Balance = new web3.utils.toBN(await I_PolyToken.balanceOf(account_investor2));
            let investor3Balance = new web3.utils.toBN(await I_PolyToken.balanceOf(account_investor3));
        ...
        it("Should investor 3 claims dividend", async () => {
            let investor1Balance = new web3.utils.toBN(await web3.eth.getBalance(account_investor1));
            let investor2Balance = new web3.utils.toBN(await web3.eth.getBalance(account_investor2));
            let investor3Balance = new web3.utils.toBN(await web3.eth.getBalance(account_investor3));
            await I_EtherDividendCheckpoint.pullDividendPayment(2, { from: account_investor3, gasPrice: 0 });
            let investor1BalanceAfter1 = new web3.utils.toBN(await web3.eth.getBalance(account_investor1));
            let investor2BalanceAfter1 = new web3.utils.toBN(await web3.eth.getBalance(account_investor2));
            let investor3BalanceAfter1 = new web3.utils.toBN(await web3.eth.getBalance(account_investor3));
        ...
        it("Issuer pushes remainder", async () => {
            ...
            let investor1BalanceAfter2 = new web3.utils.toBN(await web3.eth.getBalance(account_investor1));
            let investor2BalanceAfter2 = new web3.utils.toBN(await web3.eth.getBalance(account_investor2));
            let investor3BalanceAfter2 = new web3.utils.toBN(await web3.eth.getBalance(account_investor3));
        ...
        it("Investor 2 claims dividend", async () => {
            ...
            let investor2Balance = new web3.utils.toBN(await web3.eth.getBalance(account_investor2));
            let investor3Balance = new web3.utils.toBN(await web3.eth.getBalance(account_investor3));
            let tempBalance = new web3.utils.toBN(await web3.eth.getBalance(account_temp));
            await I_EtherDividendCheckpoint.pullDividendPayment(3, { from: account_investor2, gasPrice: 0 });
            let investor1BalanceAfter1 = new web3.utils.toBN(await web3.eth.getBalance(account_investor1));
            let investor2BalanceAfter1 = new web3.utils.toBN(await web3.eth.getBalance(account_investor2));
            let investor3BalanceAfter1 = new web3.utils.toBN(await web3.eth.getBalance(account_investor3));
            let tempBalanceAfter1 = new web3.utils.toBN(await web3.eth.getBalance(account_temp));
            assert.equal(investor1BalanceAfter1.sub(investor1Balance).toNumber(), 0);
        ...
        it("Should issuer pushes investor 1 and temp investor", async () => {
            ...
            let investor2BalanceAfter2 = new web3.utils.toBN(await web3.eth.getBalance(account_investor2));
            let investor3BalanceAfter2 = new web3.utils.toBN(await web3.eth.getBalance(account_investor3));
            let tempBalanceAfter2 = new web3.utils.toBN(await web3.eth.getBalance(account_temp));
            assert.equal(investor1BalanceAfter2.sub(investor1BalanceAfter1).toNumber(), 0);
        ...
        it("Issuer is able to reclaim dividend after expiry", async () => {
            let tokenOwnerBalance = new web3.utils.toBN(await web3.eth.getBalance(token_owner));
            await I_EtherDividendCheckpoint.reclaimDividend(3, { from: token_owner, gasPrice: 0 });
            let tokenOwnerAfter = new web3.utils.toBN(await web3.eth.getBalance(token_owner));
        ...
        it("Should issuer pushes all dividends", async () => {
            let investor1BalanceBefore = new web3.utils.toBN(await web3.eth.getBalance(account_investor1));
            let investor2BalanceBefore = new web3.utils.toBN(await web3.eth.getBalance(account_investor2));
            let investor3BalanceBefore = new web3.utils.toBN(await web3.eth.getBalance(account_investor3));
            let tempBalanceBefore = new web3.utils.toBN(await web3.eth.getBalance(account_temp));
            let tokenBalanceBefore = new web3.utils.toBN(await web3.eth.getBalance(I_PolyToken.address));

            await I_EtherDividendCheckpoint.pushDividendPayment(4, 0, 10, { from: token_owner });

            let investor1BalanceAfter = new web3.utils.toBN(await web3.eth.getBalance(account_investor1));
            let investor2BalanceAfter = new web3.utils.toBN(await web3.eth.getBalance(account_investor2));
            let investor3BalanceAfter = new web3.utils.toBN(await web3.eth.getBalance(account_investor3));
            let tempBalanceAfter = new web3.utils.toBN(await web3.eth.getBalance(account_temp));
            let tokenBalanceAfter = new web3.utils.toBN(await web3.eth.getBalance(I_PolyToken.address));
