...
const SingleTradeVolumeRestrictionManagerFactory = artifacts.require('./STVRMFactory.sol');
const SingleTradeVolumeRestrictionManager = artifacts.require('./STVRManager');
