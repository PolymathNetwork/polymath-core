...
module.exports = function (deployer, network, accounts) {
  ...
  return deployer.deploy(PolymathRegistry, {from: PolymathAccount}).then(() => {
    ...
    return deployer.deploy(GeneralTransferManagerFactory, PolyToken, 0, 0, 0, PolymathRegistry.address, {from: PolymathAccount});
  }).then(() => {
    ...
    return deployer.deploy(GeneralPermissionManagerFactory, PolyToken, 0, 0, 0, PolymathRegistry.address, {from: PolymathAccount});
  }).then(() => {
    ...
    return deployer.deploy(CountTransferManagerFactory, PolyToken, 0, 0, 0, PolymathRegistry.address, {from: PolymathAccount});
  }).then(() => {
    ...
    return deployer.deploy(PercentageTransferManagerFactory, PolyToken, 0, 0, 0, PolymathRegistry.address, {from: PolymathAccount});
  }).then(() => {
    ...
    return deployer.deploy(EtherDividendCheckpointFactory, PolyToken, 0, 0, 0, PolymathRegistry.address, {from: PolymathAccount});
  }).then(() => {
    ...
    return deployer.deploy(ERC20DividendCheckpointFactory, PolyToken, 0, 0, 0, PolymathRegistry.address, {from: PolymathAccount});
  }).then(() => {
      ...
      return deployer.deploy(ManualApprovalTransferManagerFactory, PolyToken, 0, 0, 0, PolymathRegistry.address, {from: PolymathAccount});
  }).then(() => {
   ...
   return polymathRegistry.changeAddress("SecurityTokenRegistry", SecurityTokenRegistryProxy.address, {from: PolymathAccount});
    ...
    return deployer.deploy(CappedSTOFactory, PolyToken, cappedSTOSetupCost, 0, 0, PolymathRegistry.address, {from: PolymathAccount})
  }).then(() => {
  ...
  return moduleRegistry.verifyModule(CappedSTOFactory.address, true, {from: PolymathAccount})
    ...
    return deployer.deploy(USDTieredSTOFactory, PolyToken, usdTieredSTOSetupCost, 0, 0, USDTieredSTOProxyFactory.address, PolymathRegistry.address, {from: PolymathAccount})
  }).then(() => {
