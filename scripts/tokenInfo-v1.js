...
const securityTokenABI = JSON.parse(
    require("fs")
        .readFileSync("../CLI/data/SecurityToken1-4-0.json")
        .toString()
).abi;
const generalTransferManagerABI = JSON.parse(
    require("fs")
        .readFileSync("../CLI/data/GeneralTransferManager1-4-0.json")
        .toString()
).abi;
...
async function getTokens() {
    ...
    let logs = await getLogsFromEtherscan(
        ...
        web3.utils.hexToNumber("0x5C5C18"),
        "latest",
