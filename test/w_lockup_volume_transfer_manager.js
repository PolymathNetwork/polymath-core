...
contract('LockupVolumeTransferManager', accounts => {
    ...
    describe("Buy tokens using on-chain whitelist and test locking them up and attempting to transfer", async() => {
        ...
        it("Should successfully attach the LockupVolumeTransferManager with the security token", async () => {
            ...
            const tx_add = await I_LockupVolumeTransferManager.addLockUp(account_investor1,
                                                                        0,
                                                                        3600,
                                                                        3,
                                                                        10000, {from: token_owner});
            
            console.log(tx_add.logs);

            await new Promise(resolve => setTimeout(resolve, 4000));

            const tx_verify = await I_LockupVolumeTransferManager.verifyTransfer(account_investor1,
                                                                                account_investor2,
                                                                                200,
                                                                                "",
                                                                                true);
            
            // print still in lockup
            console.log(tx_verify.logs[0].args._number.toNumber());
        });
        ...
        //     await catchRevert(
        //         I_LockupVolumeTransferManager.addLockUp(account_investor2, 16, 4, 0, 0, { from: token_owner })
        //     )
        // });
        ...
        //     await catchRevert(
        //         I_LockupVolumeTransferManager.addLockUp(account_investor2, 16, 0, 0, web3.utils.toWei('1', 'ether'), { from: token_owner })
        //     );
        // });
        ...
        //     await catchRevert(
        //         I_LockupVolumeTransferManager.addLockUp(account_investor2, 0, 4, 0, web3.utils.toWei('1', 'ether'), { from: token_owner })
        //     );
        // });
        ...
        //     await catchRevert(
        //         I_LockupVolumeTransferManager.addLockUp(account_investor2, 16, 4, 0, web3.utils.toWei('0.5', 'ether'), { from: token_owner })
        //     );
        // });
        ...
        //     await catchRevert(
        //         I_LockupVolumeTransferManager.addLockUp(account_investor2, 17, 4, 0, balance, { from: token_owner })
        //     );
        // });
        ...
        //     await catchRevert(
        //         I_LockupVolumeTransferManager.addLockUp(account_investor2, web3.utils.toWei('16', 'ether'), 4, 0, web3.utils.toWei('1', 'ether'), { from: token_owner })
        //     );
        // });
        ...
        //     await catchRevert(
        //         I_LockupVolumeTransferManager.addLockUp(account_investor2, 16, 4, 0, balance, { from: token_owner })
        //     );
        ...
        //     await I_LockupVolumeTransferManager.addLockUp(account_investor2, 12, 4, 0, balance, { from: token_owner });
        ...
        //     // create a lockup for their entire balance
        //     // over 16 seconds total, with 4 periods of 4 seconds each.
        //     await I_LockupVolumeTransferManager.addLockUp(account_investor1, 16, 4, 0, balance, { from: token_owner });
        ...
        //     // edit the lockup
        //     await I_LockupVolumeTransferManager.modifyLockUp(account_investor1, 0, 8, 4, 0, balance, { from: token_owner });
        ...
        //     await I_LockupVolumeTransferManager.addLockUp(account_investor2, 100, 10, now + 4, balance, { from: token_owner });
        ...
        //     // edit the lockup
        //     await I_LockupVolumeTransferManager.modifyLockUp(account_investor2, 0, 8, 4, now + 4, balance, { from: token_owner });
        ...
        //     await I_LockupVolumeTransferManager.addLockUp(account_investor1, 12, 4, 0, web3.utils.toWei('6', 'ether'), { from: token_owner });
        ...
        //     await I_LockupVolumeTransferManager.addLockUp(account_investor1, 16, 4, 0, web3.utils.toWei('8', 'ether'), { from: token_owner });
