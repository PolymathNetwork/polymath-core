...
contract('USDTieredSTO', accounts => {
  ...
  describe('Test buying failure conditions', async () => {
    ...
    it('should fail and revert despite oracle price change when NONACCREDITED cap reached', async () => {
      ...
      await catchRevert(
        I_USDTieredSTO_Array[stoId].buyWithETH(NONACCREDITED1, { from: NONACCREDITED1, value: investment_ETH_high, gasPrice: GAS_PRICE })
      );
      ...
      await catchRevert(
        I_USDTieredSTO_Array[stoId].buyWithETH(NONACCREDITED1, { from: NONACCREDITED1, value: investment_ETH_low, gasPrice: GAS_PRICE })
      );
