...
library Util {
    ...
    */
    function upper(string _base) public pure returns (string) {
     ...
     */
    /// Notice - Maximum length for _source will be 32 chars otherwise returned bytes32 value will have lossy value.
    function bytesToBytes32(bytes _b, uint _offset) public pure returns (bytes32) {
        bytes32 result;
     ...
     * @return bytes4 sig
     */
    function getSig(bytes _data) public pure returns (bytes4 sig) {
