...
contract('ERC20DividendCheckpoint', accounts => {
  ...
  describe('Check Dividend payouts', async () => {
    ...
    it('Should fail in creating the dividend - incorrect allowance', async () => {
      ...
      await catchRevert(
        I_ERC20DividendCheckpoint.createDividend(maturity, expiry, I_PolyToken.address, web3.utils.toWei('1.5', 'ether'), dividendName, {
          from: token_owner
        }),
    ...
    it('Should not allow withholding greater than limit', async () => {
      ...
      await catchRevert(I_ERC20DividendCheckpoint.setWithholdingFixed([account_temp], BigNumber(20 * 10 ** 26), { from: token_owner }), '');
    });
    ...
    describe('Test cases for the ERC20DividendCheckpointFactory', async () => {
      it('should get the exact details of the factory', async () => {
        ...
        assert.equal(
          await I_ERC20DividendCheckpointFactory.getDescription.call(),
