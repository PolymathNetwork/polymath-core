...
const ADD_LOCKUP_DATA_CSV = './CLI/data/Transfer/LockupTM/add_lockup_data.csv';
const MODIFY_LOCKUP_DATA_CSV = './CLI/data/Transfer/LockupTM/modify_lockup_data.csv';
const DELETE_LOCKUP_DATA_CSV = './CLI/data/Transfer/LockupTM/delete_lockup_data.csv';
const ADD_LOCKUP_INVESTOR_DATA_CSV = './CLI/data/Transfer/LockupTM/add_lockup_investor_data.csv';
const REMOVE_LOCKUP_INVESTOR_DATA_CSV = './CLI/data/Transfer/LockupTM/remove_lockup_investor_data.csv';
