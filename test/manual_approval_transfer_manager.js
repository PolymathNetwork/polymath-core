...
contract('ManualApprovalTransferManager', accounts => {
    ...
    before(async() => {
        ...
        I_ManualApprovalTransferManagerFactory = await ManualApprovalTransferManagerFactory.new(I_PolyToken.address, {from:account_polymath});
        assert.notEqual(
    ...
    describe("ManualApproval Transfer Manager Factory test cases", async() => {
        ...
        it("Should get the exact details of the factory", async() => {
            assert.equal(await I_ManualApprovalTransferManagerFactory.getCost.call(),0);
