...
import {deployWeightedVoteAndVerified, setUpPolymathNetwork } from "./helpers/createInstances";
...
contract('WeightedVoteCheckpoint', accounts => {
    ...
    [I_WeightedVoteCheckpointFactory] = await deployWeightedVoteAndVerified(account_polymath, I_MRProxied, I_PolyToken.address, 0);
    [P_WeightedVoteCheckpointFactory] = await deployWeightedVoteAndVerified(account_polymath, I_MRProxied, I_PolyToken.address, web3.utils.toWei("500"));
