    ...
    */
    ...
    describe("Polimath network status post migration", async() => {
        ...
        it("Should successfully launch USDTieredSTO for first security token", async() => {
            ...
            let _ratePerTier = [new BigNumber(0.1).mul(10**18), new BigNumber(0.15).mul(10**18), new BigNumber(0.2).mul(10**18)];
            let _ratePerTierDiscountPoly = [new BigNumber(0), new BigNumber(0), new BigNumber(0)];
            let _tokensPerTierTotal = [new BigNumber(100).mul(10**18), new BigNumber(200).mul(10**18), new BigNumber(300).mul(10**18)];
            let _tokensPerTierDiscountPoly = [new BigNumber(0), new BigNumber(0), new BigNumber(0)];
        ...
        */
        ...
        it("Should successfully launch CappedSTO for third security token", async() => {
            ...
            let cap = new BigNumber(500000).mul(10**18);
            let rate = 1000;
            let fundRaiseType = 0;
