...
interface IUSDTieredSTOProxy {
     ...
     */
    function deploySTO(address _securityToken, address _factoryAddress) external returns(address STOAddress);
     ...
     * @return bytes4
     */
    function getInitFunction(address _contractAddress) external returns(bytes4 initFunction);
